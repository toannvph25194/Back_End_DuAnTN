...
public interface HoaDonChiTietAdminService {
    ...
    MessageGioHangCTRespon addSPHDCT(UUID idhdct, UUID idspct, Integer soluong, Double dongiakhigiam);

    // update soluong HDCT theo idghct
    MessageGioHangCTRespon updateHDCT(UUID idHDCT, Integer soluong);

    // delete hdct theo idghct
    MessageGioHangCTRespon deleteHoaDonCT(UUID idghct);
}
