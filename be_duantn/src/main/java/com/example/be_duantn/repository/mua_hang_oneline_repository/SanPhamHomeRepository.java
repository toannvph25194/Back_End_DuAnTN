...
public interface SanPhamHomeRepository extends JpaRepository<SanPham , UUID> {
    ...
    @Query(value = "SELECT DISTINCT TOP 6 sp.Id,MaSP, sp.TenSP, sp.ImageDefaul, sp.TheLoai, spgg.DonGia, spgg.DonGiaKhiGiam, spgg.SoLuongBan FROM SPGiamGia spgg\n" +
            ...
            "ORDER BY spgg.SoLuongBan DESC;",nativeQuery = true)
